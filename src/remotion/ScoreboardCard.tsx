                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      opacity: rowOpacity,
                      display: "grid",
                      gridTemplateColumns: "68px 1fr 72px",
                      alignItems: "center",
                      padding: "7px 10px",
                      borderRadius: 12,
                      boxSizing: "border-box" as const,
                  ...
                  >
                    ...
                    >
                      <span style={{ position: "absolute", inset: 0, opacity: badgeOpacityA }}>
                        {ordinalBadge(r0)}
                      </span>
                      <span style={{ position: "absolute", inset: 0, opacity: badgeOpacityB }}>
                        {ordinalBadge(r1)}
                      </span>
                      <span style={{ position: "absolute", inset: 0, opacity: badgeOpacityC }}>
                        {ordinalBadge(r2)}
                      </span>
                      <span style={{ opacity: 0 }}>{ordinalBadge(r2)}</span>
                    </span>
