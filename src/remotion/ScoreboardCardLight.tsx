...
export const ScoreboardCardLight = () => {
      ...
      >
        ...
        <div
          style={{
            ...
            boxShadow:
              "inset 0 1px 0 rgba(255, 255, 255, 0.88), 0 14px 28px rgba(31, 67, 132, 0.26)",
            display: "flex",
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: entry.isYou
                        ? [
                            `0 10px 26px rgba(37, 99, 235, ${0.12 + highlight * 0.18})`,
                            `0 0 0 1px rgba(37, 99, 235, ${0.14 + highlight * 0.22})`,
                          ].join(", ")
                        : "none",
                    }}
                  >
