...
const SUCCESS_RGB = "18, 163, 109";
const DANGER_RGB = "187, 59, 81";
const DANGER  = "#bb3b51";
...
function Input({
  ...
  return (
    <div style={{
      ...
      fontSize:           13,
      color:              value ? INK : "rgba(98,120,159,0.42)",
...
export const TicketPanelDemoLight = () => {
  ...
  return (
    <AbsoluteFill style={{ background: BG, overflow: "hidden", fontFamily: FONT }}>
      ...
      <div style={{
        ...
        background:   "linear-gradient(160deg, rgba(255, 255, 255, 0.86) 0%, rgba(246, 251, 255, 0.74) 100%)",
        ...
        <div style={{ marginTop: 12, display: "grid", gap: 10 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              border: "1px solid rgba(129, 160, 212, 0.24)",
            }}>
              {/* Market tab (inactive) */}
              <div style={{
                borderRadius: 9,
          ...
          <div style={{
            ...
            <div style={{
              ...
              border:        `1px solid rgba(${SUCCESS_RGB},${buyBorderAlpha.toFixed(3)})`,
              background:    `rgba(${SUCCESS_RGB},${buyBgAlpha.toFixed(3)})`,
              color:         SUCCESS,
