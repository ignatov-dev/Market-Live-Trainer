...
export const SessionSummaryCardLight = () => {
  ...
  return (
    <AbsoluteFill style={{ background: BG, overflow: "hidden" }}>
      ...
      {/* ── Ambient blobs ────────────────────────────────────────────────── */}
      <Blob cx={200}  cy={180}  r={260} color="rgba(37,99,235,0.12)" opacity={1}
        frame={frame} speedX={0.018} speedY={0.012} phase={0} />
      <Blob cx={1720} cy={200}  r={220} color="rgba(16,185,129,0.12)" opacity={1}
        frame={frame} speedX={0.014} speedY={0.020} phase={2.1} />
      <Blob cx={960}  cy={900}  r={300} color="rgba(37,99,235,0.08)" opacity={1}
        frame={frame} speedX={0.010} speedY={0.008} phase={1.0} />
      <Blob cx={400}  cy={820}  r={180} color="rgba(16,185,129,0.08)" opacity={1}
        frame={frame} speedX={0.022} speedY={0.016} phase={3.5} />
      <Blob cx={1580} cy={780}  r={200} color="rgba(37,99,235,0.08)" opacity={1}
      ...
      <div style={{
        ...
        <div style={{
          ...
          boxShadow: [
            ...
            `0 ${(shadowBlur * 0.4) / CARD_SCALE}px ${(shadowBlur * 1.0) / CARD_SCALE}px rgba(31, 67, 132, ${shadowOpacity * 0.8})`,
          ].join(", "),
          display:       "flex",
