...
const BG = [
  "radial-gradient(120% 90% at 0% 0%, rgba(0, 102, 255, 0.2) 0%, rgba(0, 102, 255, 0) 50%)",
    ...
    <AbsoluteFill style={{ background: BG, overflow: "hidden", fontFamily: FONT }}>
      ...
      <div
        style={{
          ...
          background:
            "linear-gradient(165deg, rgba(20, 28, 46, 0.68) 0%, rgba(12, 16, 28, 0.78) 100%)",
      ...
      >
        <div
          style={{
            ...
            borderRadius: 14,
            background:
              "linear-gradient(180deg, rgba(202, 223, 255, 0.2) 0%, rgba(202, 223, 255, 0) 44%)",
            pointerEvents: "none",
          }}
        />
