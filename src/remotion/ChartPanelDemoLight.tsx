    ...
    >
      ...
      {yTicks.map(({ y, price }, i) => (
        <g key={`py${i}`}>
          ...
          <text x={labelX} y={y} dominantBaseline="middle"
            fontFamily={MONO} fontSize={10} fill="rgba(98, 120, 159, 0.9)">
            ${fmtScale(price)}
          </text>
        </g>
      ))}
      ...
      {xTicks.map(({ x }, i) => (
        <line key={`vl${i}`} x1={x} y1={PAD.top} x2={x} y2={PAD.top + chartH}
          stroke="rgba(117, 146, 194, 0.2)" strokeWidth={1} strokeDasharray="3 3" />
      ))}
      ...
      {xTicks.map(({ x, label, align }, i) => (
        <g key={`xl${i}`}>
          ...
          <text x={x} y={PAD.top + chartH + 24}
            ...
            fontFamily={MONO} fontSize={10} fill="rgba(98, 120, 159, 0.88)">
            {label}
          </text>
        </g>
      ))}
        ...
        return (
          <g key={`c${idx}`}>
            ...
            <line x1={x} y1={highY} x2={x} y2={lowY}
              stroke={rising ? "#12a36d" : "#bb3b51"} strokeWidth={1} />
            {/* Body */}
            <rect
              x={x - bodyW / 2} y={bodyTop}
              width={bodyW} height={bodyH}
              fill={rising ? "#12a36d" : "#bb3b51"}
            />
          </g>
        );
      })}
      ...
      <text x={labelX} y={lastY} dominantBaseline="middle"
        fontFamily={MONO} fontSize={10} fill="rgba(37, 99, 235, 0.92)">
        {lastLabel}
      </text>
    </svg>
  );
...
export const ChartPanelDemoLight = () => {
  ...
  return (
    <AbsoluteFill style={{ background: BG, overflow: "hidden", fontFamily: FONT }}>
      ...
      {/* ── Ambient blobs ── */}
      <Blob cx={200}  cy={180}  r={260} color="rgba(37,99,235,0.12)" opacity={1} frame={frame} speedX={0.018} speedY={0.012} phase={0} />
      <Blob cx={1720} cy={200}  r={220} color="rgba(16,185,129,0.12)" opacity={1} frame={frame} speedX={0.014} speedY={0.020} phase={2.1} />
      <Blob cx={960}  cy={900}  r={300} color="rgba(37,99,235,0.08)" opacity={1} frame={frame} speedX={0.010} speedY={0.008} phase={1.0} />
      <Blob cx={400}  cy={820}  r={180} color="rgba(16,185,129,0.08)" opacity={1} frame={frame} speedX={0.022} speedY={0.016} phase={3.5} />
      <Blob cx={1580} cy={780}  r={200} color="rgba(37,99,235,0.08)" opacity={1} frame={frame} speedX={0.016} speedY={0.024} phase={5.2} />
      ...
      <div style={{
        ...
        background:   "linear-gradient(165deg, rgba(255, 255, 255, 0.86) 0%, rgba(247, 251, 255, 0.76) 100%)",
        boxShadow:    "0 16px 38px rgba(31, 67, 132, 0.18)",
        padding:      PAD,
        ...
        <div style={{
          ...
          left:          0,
          borderRadius:  14,
          background:    "linear-gradient(180deg, rgba(255, 255, 255, 0.72) 0%, rgba(255, 255, 255, 0) 46%)",
          pointerEvents: "none",
        }} />
        ...
        <div style={{
          ...
          <div style={{
            ...
            gap:          2,
            borderRadius: 12,
            background:   "linear-gradient(170deg, rgba(255, 255, 255, 0.9) 0%, rgba(245, 250, 255, 0.82) 100%)",
            ...
            {PAIRS.map((label, i) => (
                <span key={label} style={{
                  ...
                  background:    i === ACTIVE_PAIR ? "rgba(37, 99, 235, 0.12)" : "transparent",
                }}>
                  {label}
                </span>
            ))}
          ...
          <div style={{
            ...
            {TIMEFRAMES.map((label, i) => (
                <span key={label} style={{
                  ...
                  background:    i === ACTIVE_TF ? "rgba(37, 99, 235, 0.12)" : "transparent",
                }}>
                  {label}
                </span>
            ))}
        ...
        <div style={{
          ...
          boxShadow:    "inset 0 1px 0 rgba(255, 255, 255, 0.88), 0 8px 24px rgba(31, 67, 132, 0.1)",
        }}>
